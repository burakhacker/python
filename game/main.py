...
class Snake:
    def __init__(self, canvas):
        ...
        for i in range(0, BODY_PARTS):
            ...
            square = self.canvas.create_rectangle(i * SPACE_SIZE, 0, (i + 1) * SPACE_SIZE, SPACE_SIZE, fill=SNAKE_COLOR, tag="snake")
...
def next_turn(snake, food):
    ...
    square = snake.canvas.create_rectangle(x, y, x + SPACE_SIZE, y + SPACE_SIZE, fill=SNAKE_COLOR)
    ...
    if x == food.coordinates[0] and y == food.coordinates[1]:
        ...
        food.canvas.delete("food")
        food = Food(snake.canvas)
    else:
...
def game_over():
    ...
    snake.canvas.create_text(snake.canvas.winfo_width()/2, snake.canvas.winfo_height()/2,
